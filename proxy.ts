...
const PUBLIC_PATHS = ["/", "/login", "/signup", "/forgot-password", "/manifest.webmanifest", "/icon", "/icon.svg", "/apple-icon.png", "/og.png", "/sw.js", "/offline.html", "/api/stripe/webhook", "/terms", "/privacy", "/refund-policy", "/support", "/features", "/subjects", "/pricing", "/faq", "/request-access"];
