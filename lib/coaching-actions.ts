...
import { bookingErrorMessage, generateWeeklySlots, isStripePaymentLink, isUuid, paymentLinkFor, slotsForDay, type CoachingBookingStatus } from "@/lib/coaching-core";
import { currentUser, isCoachingAdmin } from "@/lib/coaching";
