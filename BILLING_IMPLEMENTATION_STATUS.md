...
| 1. Stripe account and catalog | Commercial terms and legal identity approved; Stripe setup required | Monthly CA$59 and annual CA$349 pricing, no trial, cancellation, refund, grace, beta access, onboarding, legal business identity, business address, tax registrations, and statement descriptor decisions are approved or supplied. No Stripe variables currently exist in Vercel. The support email, test product, prices, portal, and webhook endpoint still need to be configured. |
...
| 6. Billing interface | Implemented; support email pending | Marketing pricing, Billing, Settings, portal recovery, bounded post-Checkout polling, mobile layout, accessibility, renewal and cancellation timing, approved refund terms, tax disclosure, legal links, operator identity, business address, support, and non-affiliation copy are present. The public support email remains required before live billing. |
...
1. Obtain the public support email listed in `BILLING_LAUNCH_DECISIONS.md`.
