...
import { AccessSection, FaqSection, PageIntro } from "@/components/marketing-sections";
...
export default async function FaqPage() {
  ...
  return <MarketingShell showSubjects={showSubjects} showPricing={showPricing}><PageIntro eyebrow="FAQ" title="Frequently asked questions." copy="Everything you need to know before trying the demo or requesting an invitation." /><FaqSection /><AccessSection /></MarketingShell>;
}
