...
export default async function FaqPage() {
  ...
  return <MarketingShell showSubjects={showSubjects} showPricing={showPricing} checkoutAvailable={checkoutAvailable}><PageIntro eyebrow="FAQ" title="Frequently asked questions." copy="Everything you need to know about the demo, practice sessions, content quality, progress tracking, accounts, and billing." /><ExtendedFaqSection checkoutAvailable={checkoutAvailable} /><AccessSection checkoutAvailable={checkoutAvailable} /></MarketingShell>;
}
