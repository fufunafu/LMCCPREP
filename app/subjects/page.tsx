...
export default async function SubjectsPage() {
  ...
  return <MarketingShell showSubjects={showSubjects} showPricing={showPricing} checkoutAvailable={checkoutAvailable}><PageIntro eyebrow="Subjects" title="What is inside, by exam." copy="Reviewed questions available in each discipline today. Choose your exam in Settings after signing in." /><SubjectsSection subjects={subjects} /><AccessSection checkoutAvailable={checkoutAvailable} /></MarketingShell>;
}
