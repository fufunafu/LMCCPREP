...
export default async function DashboardPage() {
  ...
  return <DashboardView stats={stats} subjects={subjects} topics={topics} recentSessions={recentSessions} userName={profile?.name} examName={exam?.shortName} profile={profile ?? undefined} />;
}
