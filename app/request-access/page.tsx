...
export default async function RequestAccessPage() {
  ...
  return <MarketingShell showSubjects={showSubjects} showPricing={showPricing} checkoutAvailable={checkoutAvailable}><PageIntro eyebrow="Request access" title="Get an invitation." copy="Montreal QBank is invite-only. Leave your university email and we will be in touch when an invitation is available. The demo is free and needs no card." /><AccessSection checkoutAvailable={checkoutAvailable} /></MarketingShell>;
}
